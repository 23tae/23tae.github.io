...
![Untitled](/assets/img/42seoul/philosophers/philo2/Untitled%201.png)
...
- 이러한 해결책들은 교착 상태의 발생 조건 중 한 가지 이상을 제거하여 **교착 상태를 방지**한다. 하지만 **기아 상태의 가능성**은 제거할 수 없으므로 추가적인 해결책이 필요하다.
