...
[참고](https://23tae.github.io/posts/os07/#식사하는-철학자들-문제dining-philosophers-problem)
...
모든 철학자가 한번에 왼쪽 포크를 들고 오른쪽 포크를 드는 알고리즘을 갖고 있다면, 모두가 동시에 왼쪽 포크를 들고 오른쪽 포크를 기다리는 **교착 상태**에 빠지게 될 수 있다.
...
- 이러한 해결책들은 교착 상태의 발생 조건 중 한 가지 이상을 제거하여 **교착 상태의 발생을 방지**할 수 있다. 하지만 **기아 상태의 가능성**은 제거할 수 없으므로 추가적인 해결책이 필요하다.
