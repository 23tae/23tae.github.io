...
# Ref.
- [c - Server receiving and showing string from client using signals SIGUSR1 and SIGUSR2 can't handle with big amount of symbols - Stack Overflow](https://stackoverflow.com/questions/69947118/server-receiving-and-showing-string-from-client-using-signals-sigusr1-and-sigusr)