...
[시대팅](https://meeting5.uoslife.net/)은 서울시립대학교 IT 동아리인 **시대생**에서 재학생들을 대상으로 운영하는 **소개팅 서비스**다. 매 학기 이벤트성으로 열리는 이 서비스는 동아리 운영비 확보와 앱 사용자 유치를 목적으로 한다. 이번 시대팅 시즌5 프로젝트는 내가 속한 TF에서 기존에 개발중이던 **맛집 혼잡도 서비스**가 의견 충돌로 무산된 후, 새로운 방향성을 모색하던 과정에서 채택되어 시작하게 되었다.
