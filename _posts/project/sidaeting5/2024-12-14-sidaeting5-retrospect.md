...
기존에 사용중이던 어카운트 서버를 활용할 수 없는 상황에서 JWT 인증 관련 기능을 새롭게 개발해야 했던 점이 이번 프로젝트에서의 가장 큰 도전 과제였다. Redis나 Amazon SES에 대한 추가적인 학습이 필요하기도 했다. 이러한 기술적인 도전이 성장의 밑거름이 되었다.
