...
본 프로젝트에는 총 10명(기존 TF 구성 그대로 넘어오다보니 소규모로 진행되었다)이 참여하였으며, 역할은 PM, 기획, 마케팅, 디자이너, 프론트엔드, 백엔드로 구성되었다. 협업 도구로는 Slack, Notion, Discord, 카카오톡을 사용했으며, API 명세 공유에는 Swagger를 활용했다. 백엔드 간 협업은 Slack과 대면 작업을 적절히 섞어 진행하였다.
