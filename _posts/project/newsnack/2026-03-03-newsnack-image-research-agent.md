...
지금까지 구축한 독립적인 리서치 에이전트 노드가 기존 파이프라인에 결합된 뉴스툰 전체 워크플로우는 다음과 같다.

![newstoon_workflow_2](/assets/img/project/newsnack/image-research-agent/newstoon_workflow_v2.webp)
_완성된 '뉴스툰' 워크플로우_
